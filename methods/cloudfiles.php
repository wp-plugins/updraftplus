...
if (defined('UPDRAFTPLUS_EXPERIMENTAL_MISC') && true == UPDRAFTPLUS_EXPERIMENTAL_MISC && version_compare(phpversion(), '5.3.3', '>=') && (!defined('UPDRAFTPLUS_CLOUDFILES_USEOLDSDK') || UPDRAFTPLUS_CLOUDFILES_USEOLDSDK != true)) {
